...
module.exports = (sequelize, DataTypes) => {
  const ClinicGoogleAdsAccount = sequelize.define('ClinicGoogleAdsAccount', {
    ...
    publishingStatus: { type: DataTypes.STRING(128), allowNull: true, field: 'publishingStatus' },
    publishingReason: { type: DataTypes.TEXT, allowNull: true, field: 'publishingReason' },
    publishingReasons: { type: DataTypes.TEXT('long'), allowNull: true, field: 'publishingReasons' },
    publishingCampaignId: { type: DataTypes.STRING(64), allowNull: true, field: 'publishingCampaignId' },
    publishingCampaignName: { type: DataTypes.STRING(256), allowNull: true, field: 'publishingCampaignName' },
    publishingSyncedAt: { type: DataTypes.DATE, allowNull: true, field: 'publishingSyncedAt' },
