...
module.exports = (sequelize, D) => sequelize.define('AuthSession', {
  ...
  authentication_method: { type: D.ENUM('password', 'password_email', 'password_trusted_device'), allowNull: false, defaultValue: 'password' },
  email_verified_at: { type: D.DATE(3), allowNull: true },
  email_challenge_id: { type: D.UUID, allowNull: true, unique: true },
  trusted_device_id: { type: D.UUID, allowNull: true },
