...
module.exports = (sequelize, DataTypes) => {
  ...
  MarketingPatientList.init({
    ...
    email_template_id: { type: DataTypes.INTEGER.UNSIGNED, allowNull: true },
    email_sender_identity_id: { type: DataTypes.INTEGER.UNSIGNED, allowNull: true },
    email_dispatch: { type: DataTypes.JSON, allowNull: true },
