...
module.exports = (sequelize, DataTypes) => {
  const GoogleAdsInsightsDaily = sequelize.define('GoogleAdsInsightsDaily', {
    ...
    campaignServingStatus: { type: DataTypes.STRING(64), allowNull: true, field: 'campaignServingStatus' },
    campaignPrimaryStatus: { type: DataTypes.STRING(64), allowNull: true, field: 'campaignPrimaryStatus' },
    campaignPrimaryStatusReasons: { type: DataTypes.TEXT('long'), allowNull: true, field: 'campaignPrimaryStatusReasons' },
