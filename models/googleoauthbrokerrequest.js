...
module.exports = (sequelize, D) => sequelize.define('GoogleOAuthBrokerRequest', {
  ...
  cohort: { type: D.ENUM('business_profile', 'search_console', 'analytics', 'ads'), allowNull: false, defaultValue: 'business_profile' },
  policy_version: { type: D.STRING(64), allowNull: false, defaultValue: 'google-oauth-pinned-v1' },
  request_scope_key: { type: D.STRING(64), allowNull: true },
