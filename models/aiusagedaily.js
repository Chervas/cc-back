...
module.exports = (sequelize, DataTypes) => {
  const AiUsageDaily = sequelize.define('AiUsageDaily', {
    ...
    cachedInputTokens: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, defaultValue: 0, field: 'cached_input_tokens' },
    audioSeconds: { type: DataTypes.DECIMAL(18, 3), allowNull: false, defaultValue: 0, field: 'audio_seconds' },
    searchRequests: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'search_requests' },
    unpricedRequests: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'unpriced_requests' },
