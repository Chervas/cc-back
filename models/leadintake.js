...
module.exports = (sequelize, DataTypes) => {
  ...
  LeadIntake.init({
    ...
    callback_reminder_at: { type: DataTypes.DATE, allowNull: true },
    callback_reminder_reason: { type: DataTypes.STRING(512), allowNull: true },
    callback_reminder_notes: { type: DataTypes.TEXT, allowNull: true },
    callback_reminder_created_by: { type: DataTypes.INTEGER, allowNull: true },
    callback_reminder_job_id: { type: DataTypes.INTEGER, allowNull: true },
    callback_reminder_notified_at: { type: DataTypes.DATE, allowNull: true },
