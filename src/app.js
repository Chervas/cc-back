...
const appointmentFlowInstancesRoutes = require('./routes/appointment-flow-instances.routes');
...
app.use('/api/appointment-flow-instances', appointmentFlowInstancesRoutes);
console.log('Ruta /api/appointment-flow-instances configurada');
