...
const patientFollowUpsRoutes = require('./routes/patientFollowUps.routes');
const treatmentProgramsRoutes = require('./routes/treatmentPrograms.routes');
const tratamientosRoutes = require('./routes/tratamientos.routes');
const treatmentDocumentationRoutes = require('./routes/treatmentDocumentation.routes');
const patientEconomicsRoutes = require('./routes/patientEconomics.routes');
...
const patientDirectionRoutes = require('./routes/patientDirection.routes');
...
app.use('/api/patient-follow-ups', patientFollowUpsRoutes);
...
app.use('/api/patient-direction', patientDirectionRoutes);
...
app.use('/api/treatment-documentation', treatmentDocumentationRoutes);
console.log('Ruta /api/tratamientos configurada');
app.use('/api/economics', patientEconomicsRoutes);
console.log('Ruta /api/economics configurada');
app.use('/api/accounting', accountingRoutes);
console.log('Ruta /api/accounting configurada');
