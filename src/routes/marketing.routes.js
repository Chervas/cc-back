...
router.get('/campaign-workspace/ad-creative', campaignWorkspaceController.getAdCreative);
...
router.get('/campaign-workspace/shared-account', campaignWorkspaceController.getSharedAccountReview);
...
router.get('/campaign-workspace/meta-preparation/jobs/:jobId', campaignWorkspaceController.getMetaPageReceptionJob);
