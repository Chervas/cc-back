...
router.delete('/v2/templates/:template_ref', automationsV2Controller.deleteTemplate);
router.get('/v2/templates/:template_ref', automationsV2Controller.getTemplateLatestPublished);
router.get('/v2/templates/:template_ref/versions', automationsV2Controller.listTemplateVersions);
router.get('/v2/templates/:template_ref/versions/:version', automationsV2Controller.getTemplateVersion);
router.put('/v2/templates/:template_ref/versions/:version', automationsV2Controller.updateTemplateDraft);
router.post('/v2/templates/:template_ref/versions/:version/publish', automationsV2Controller.publishTemplateVersion);
router.post('/v2/templates/:template_ref/versions/:version/execute', automationsV2Controller.executeTemplateVersion);
