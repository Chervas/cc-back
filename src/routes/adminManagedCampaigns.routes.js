...
router.post('/:id/publishing-executions', controller.createPublishingExecution);
router.get('/:id/publishing-executions', controller.listPublishingExecutions);
router.post('/:id/publishing-executions/:executionId/activate', controller.createPublishingActivation);
router.post('/:id/publishing-executions/:executionId/rollback', controller.createPublishingRollback);
