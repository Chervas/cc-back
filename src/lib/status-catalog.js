...
const CITA_STATUSES = Object.freeze([
  {
    value: 'pendiente',
    label: 'Pendiente',
    description: 'Cita creada y pendiente de acción o confirmación',
    color: 'amber',
  ...
  },
  {
    value: 'info_enviada',
    label: 'Info enviada',
    description: 'Información inicial enviada al paciente',
    color: 'amber',
  ...
  },
  {
    ...
    label: 'Datos de cita confirmados',
    description: 'Paciente confirma recepción de los datos iniciales de la cita',
    color: 'emerald',
  ...
  {
    value: 'cambio_solicitado',
    label: 'Cambio solicitado',
    description: 'El paciente ha pedido revisar la fecha u hora y recepción debe resolverlo',
    color: 'amber',
