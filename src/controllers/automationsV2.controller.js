...
const NODE_TYPES_V2 = [
  ...
  },
  {
    ...
    category: 'action',
    label: 'Enviar Email',
    description: 'Encola un email durable mediante el sistema transaccional.',
    output_keys: ['on_success', 'on_fail'],
    runtime_status: 'real',
    default_config: { recipient_mode: 'context_patient', recipient_to: '', template_key: '', subject: '', body_html: '', variables: {} },
    config_schema: [
      { key: 'recipient_mode', label: 'Destinatario', input_type: 'select', required: false, options: ['context_patient', 'context_lead', 'context_user', 'manual_email'] },
      { key: 'recipient_to', label: 'Email manual', input_type: 'string', required: false },
      { key: 'template_key', label: 'Plantilla', input_type: 'string', required: false },
      ...
      { key: 'body_text', label: 'Contenido texto', input_type: 'text', required: false },
      { key: 'variables', label: 'Variables', input_type: 'json', required: false },
    ],
  },
  {
