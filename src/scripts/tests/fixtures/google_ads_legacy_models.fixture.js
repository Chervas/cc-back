...
function installGoogleAdsLegacyModels(models) {
  ...
  for (const name of ['GoogleOAuthBrokerBinding', 'SearchConsoleBrokerBinding', 'AnalyticsBrokerBinding', 'GooglePropertyBrokerRevocation', 'GoogleAdsBrokerBinding', 'GoogleAdsBrokerRevocation', 'GoogleAdsEnrollmentScope', 'GoogleAdsEnrollmentRequest']) {
