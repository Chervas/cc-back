...
function loadBusinessProfileJobs({ models, broker, legacyHttp, matching, logs = [] }) {
  ...
  const sandbox = { module, exports: module.exports, Buffer, URL, URLSearchParams, Date, setTimeout, clearTimeout, setInterval: fail,
    process: { env: { RUNTIME_ROLE: 'gateway', JOBS_AUTO_START: 'false', LOCAL_SYNC_RECENT_DAYS: '1', LOCAL_SYNC_BETWEEN_LOCATIONS_SLEEP_MS: '0' } },
