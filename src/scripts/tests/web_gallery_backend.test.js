...
test('gallery compila HTML/CSS responsive, accesible y determinista en renderer 1.6', () => {
  ...
  assert.equal(first.manifest.renderer_version, 'clinicaclick-web-renderer/1.6.0');
