...
test('gallery compila HTML/CSS responsive, accesible y determinista en renderer 1.7', () => {
  ...
  assert.equal(first.manifest.renderer_version, 'clinicaclick-web-renderer/1.7.0');
