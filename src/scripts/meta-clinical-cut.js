#!/usr/bin/env node
'use strict';
// Root operator for the pinned Meta schema plan. Does not publish application
...
const operator=require('./meta-clinical-schema-release');
...
function runtime(name){
 const r=observedEnvironment(name);assert.equal(r.env.AUTH_EMAIL_MFA_MODE,'enforce');assert.equal(r.env.AUTH_SESSION_MODE,'enforce');
