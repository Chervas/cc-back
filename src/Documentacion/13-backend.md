...
- `GET /api/marketing/review-requests/summary` incluye `low_rating_reasons` con motivos privados recientes para valoraciones `1-4`, incluyendo `clinic_id` y `clinic_name` para filtrar por sede en grupos; frontend lo muestra como panel operativo, no como reseña pública.
