...
- Personal separa lectura y gestión: `team.view` permite abrir/listar personal y horarios; `team.manage` protege mutaciones sobre terceros. La edición del horario propio conserva su comprobación específica y no se convierte en gestión de terceros. Los endpoints de invitaciones, horarios, bloqueos y excepciones de terceros aceptan propietario/agencia/admin global o un override efectivo de `team.manage` para la clínica.
