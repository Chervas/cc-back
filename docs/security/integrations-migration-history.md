# Migración de seguridad: historial de avances

Antecedentes conservados con su fecha. No son instrucciones vigentes de
despliegue. Consultar el [runbook actual](../security-integrations-audit-migration.md)
y el [acta del corte público](admin-session-deployment-20260913.md).
...
Contrato, parches, interrupción, rollback y evidencia: [corte administrativo](admin-password-session-cut.md).
...
[Contrato, costes y rollback](whatsapp-onboarding-gateway.md).
...
BD compartida. [Contrato y validación](whatsapp-onboarding-broker.md).
...
[Contrato, fuentes y rollback](whatsapp-oauth-transport.md).
...
interrupción y rollback en [contrato de alta](whatsapp-authorization-state.md).
...
[WhatsApp broker](whatsapp-broker-messaging.md).
...
[Contrato, coste técnico y límites](whatsapp-broker-messaging.md).
...
[Contrato, dependencias y límites](google-ads-enrollment-application.md).
[Objetivo de la primera etapa y entregas](incremental-delivery-plan.md).
...
[Contrato y evidencia](google-ads-discovery-migration.md).
...
[Contrato, límites y lote pendiente](google-business-profile-read-migration.md):
...
[Contrato y lote](permission-audit-migration.md): corrige lectura de
...
[Contrato y lote pendiente](audit-reader-view-migration.md): consulta
...
[Contrato, QA y lote de sesiones](access-session-migration.md): emisión
...
BD: [diagnóstico y remediación preparada](database-encryption-remediation.md).
