# Historial de seguridad: referencia trasladada

> **Tipo:** alias de compatibilidad documental.
> **Fuente de verdad:** [documento central](https://github.com/Chervas/cc-front/blob/dev/src/Documentacion/98-estado-historico.md#seguridad-integraciones-2026-09).
