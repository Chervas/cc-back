...
| Conversiones/recepción | googleDataManager*, googleAdsConversion*, metaCapi, metaLeadReception, metaWorkspaceSignalDelivery, intake, googleLeadReception | grant, activo, consentimiento y comandos durables | [Motor, registro SQL y emisor común](google-data-manager-broker.md) preparados y probados offline. Resolutores workspace v2/nativos, diagnóstico y preparación aún pendientes, además de DDL/despliegue y aceptación. Meta sigue pendiente; cero doble envío al cortar |
