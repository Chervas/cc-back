...
| Conversiones/recepción | googleDataManager*, googleAdsConversion*, metaCapi, metaLeadReception, metaWorkspaceSignalDelivery, intake, googleLeadReception | grant, activo, consentimiento y comandos durables | [Motor Data Manager, cliente y reserva SQL](google-data-manager-broker.md) preparados offline; adaptación de callsites, DDL/despliegue y aceptación pendientes. Meta sigue pendiente; cero doble envío al cortar |
