...
| Conversiones/recepción | googleDataManager*, googleAdsConversion*, metaCapi, metaLeadReception, metaWorkspaceSignalDelivery, intake, googleLeadReception | grant, activo, consentimiento y comandos durables | [Motor Data Manager tipado](google-data-manager-broker.md) preparado offline; consumidores, reserva CRM durable, despliegue y aceptación pendientes. Meta sigue pendiente; cero doble envío al cortar |
