...
| OAuth/ciclo de vida | oauth.routes, whatsapp-embedded.routes, oauthConnectionPersistence, oauthScopedDisconnect, oauthConnectionHealth | app secrets, códigos, grants, tokens y bloqueos | Desconexión scoped GBP con cola/grants preparada offline. Intercambio/almacenamiento/renovación completos pendientes; nunca reactivar Meta |
...
**Migrados en runtime: ninguno.** Control adicional de revocación por activo preparado, con cola SQL, auditoría v7 y confirmación en UI. No revoca tokens OAuth; [contrato](google-business-profile-revocation-migration.md). Siete operaciones de lectura: seis de lectura en dos jobs
