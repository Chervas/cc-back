...
Fix Enhanced desplegado: el normalize/merge de activos efectivos conserva flags y autorización Enhanced en top/event/destino. Los leads `#7200/#7202/#7203` fueron previos y viajaron sin identificadores; todavía falta un lead consentido post-fix con `user_data_sent=true`, dos hashes y resultado terminal para acreditar el envío Enhanced.
