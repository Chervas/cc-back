...
const PREVIOUS_BODY_TEXT = '¡Hola {{1}}! Soy {{2}} de {{3}} 😊 ¿Te importa que te escriba por aquí para consultarte o prefieres que te llame? Queremos atenderte por el canal que te resulte más cómodo. Si prefieres una llamada, dínoslo y nos pondremos en contacto contigo.';
const BODY_TEXT = '¡Hola {{1}}! Soy {{2}} de {{3}} 😊 ¿Te importa que te escriba por aquí para consultarte o prefieres que te llame?';
