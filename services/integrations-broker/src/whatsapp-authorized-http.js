'use strict';
// Separate transport for the explicitly authorized cohort. Legacy message
// validation remains unchanged; every SEND passes the compatible typed schema.
...
const { validateMessage } = require('./whatsapp-authorized-contract');
function createWhatsappAuthorizedHttp({ request = https.request, timeoutMs = 8000 } = {}) {
...
module.exports = { createWhatsappAuthorizedHttp };
